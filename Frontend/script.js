...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('loginError').style.display = 'none'; // Hide login error message
});

// Example: Show error on failed login
document.getElementById('loginError').style.display = 'block';

// Example for admin login form validation
document.querySelector('.admin-login-card form').addEventListener('submit', function(e) {
